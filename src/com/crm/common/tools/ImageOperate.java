...
public class ImageOperate {
	private static final String UPLOADFILE = "uploadImages";
	// 将图片转换成Base64
...
//			byte[] bytes = Base64.decodeToByteArray(imgStr);
	...
	/**
	 * 返回新名称
	 * @param hostUrl 项目真实路径 getServletContext().getRealPath("/")
	 * @param fileName 文件名
	 * @return
	 */
	public static String createNewFileName(String hostUrl,String fileName) {
		RandomGenerator random = new RandomGenerator();
		String date = new SimpleDateFormat("yyMMddHHmmss").format(new Date());
		String strNewFileName = date
				+ random.nextNumberString(4)
				+ "."
				+ getExtendName(fileName);
		return hostUrl + UPLOADFILE +  File.separator + strNewFileName;
	}

	public static void main(String[] args) { // 测试从Base64编码转换为图片文件
...
//		GenerateImage(strImg, "D:\\wangyc.jpg"); 
		// 测试从图片文件转换为Base64编码
		//GenerateImage(GetImageStr("d:\\111.jpg"), "D:\\222.jpg");
//		GenerateImage(GetImageStr("d:\\444.png"), "D:\\323.jpg");
		System.out.println(GetImageStr("d:\\444.png"));
	}
}

Ext.define('crm.view.service.MyServiceList',{
	extend: 'Ext.grid.Panel',
	alias: 'widget.myservicelist',
    ...
    tbar: [
        {xtype: 'button', text: '完成服务',id:'success', iconCls: 'icon1596'},
        '-',
        {xtype: 'button', text: '已处理的列表',id:'dealed', iconCls: 'icon1596'},
        {xtype: 'button', text: '未处理的列表',id:'undeal', iconCls: 'icon1596',disabled:true},
        {xtype: 'tbfill'},
...
//		        }  
	...
	listeners:{
		beforerender: function(obj, eOpts ){
			obj.store.getProxy().url = 'service_getMyUndealList';
			obj.store.load();
		},

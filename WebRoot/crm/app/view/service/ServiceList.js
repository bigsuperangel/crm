Ext.define('crm.view.service.ServiceList',{
    ...
    tbar: [
        ...
        '-',
        {xtype: 'button', text: '未分配的',id:'undeal', iconCls: 'icon1596',disabled:true},
        {xtype: 'button', text: '处理中的',id:'deal', iconCls: 'icon1596'},
        {xtype: 'button', text: '处理完成',id:'dealed', iconCls: 'icon1596'},
        '-',
        {xtype: 'button', text: '分配服务',id:'appoint', iconCls: 'icon1596'},
        {xtype: 'button', text: '填写反馈',id:'writeReplay', iconCls: 'icon1596',disabled:true},
        {xtype: 'tbfill'},
...
//		        }  
	...
	listeners:{
		beforerender: function(obj, eOpts ){
			obj.store.getProxy().url = 'service_getUnassignationList';
			obj.store.load();
		},

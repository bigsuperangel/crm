Ext.define('crm.view.person.PersonList',{
    ...
    tbar: [
        {xtype: 'button', text: '添加',id:'addPerson', iconCls: 'icon869'},
        {xtype: 'button', text: '修改',id:'updatePerson', iconCls: 'icon871'},
        '-',
        {xtype: 'mybutton', text: '删除',id:'deletePerson',cls:'color:red', iconCls: 'icon870'},
    ],
    dockedItems:[{
		xtype:'pagingtoolbar',
		store: 'person.PersonStore',
		...
		moveLast: function(){
			var me = this;
 			...
 			store.load({
 				params:{
  			       page: totalCount,
  			       cid: me.up('personlist').model.get('id')
  			    }
  			});
 		},

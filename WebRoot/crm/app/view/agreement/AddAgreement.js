Ext.define('crm.view.agreement.AddAgreement',{
	extend: 'Ext.form.Panel',
	alias: 'widget.addagreement',
...
//	            msgTarget: 'under',
	...
	listeners:{
		beforerender: function(obj, eOpts ){
    		obj.getForm().findField('customer.id').setValue(obj.model.get('id'));
			Ext.getCmp('tips').html = '为客户：【'+obj.model.get('customerName')+'】添加合同：';
		}
	}
});
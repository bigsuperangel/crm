Ext.define('crm.view.cooperate.CooperateUnauditList',{
	extend: 'Ext.grid.Panel',
	alias: 'widget.cooperateunauditlist',
	
    store: 'cooperate.CooperateUnauditStore',
    columnLines: true,
    selModel: {
    ...
    tbar: [
        {xtype: 'button', text: '审批通过',id:'accept', iconCls: 'icon4'},
        {xtype: 'button', text: '审批驳回',id:'refuse', iconCls: 'icon214'},
        {xtype: 'tbfill'},
        {
			xtype: 'combobox',
		    name: 'cooperatorType',

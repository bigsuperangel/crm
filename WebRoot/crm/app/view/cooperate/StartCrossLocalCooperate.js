 ...
 * 跨区域合作
 */
Ext.define('crm.view.cooperate.StartCrossLocalCooperate',{
	extend: 'Ext.form.Panel',
	alias: 'widget.startcrosslocalcooperate',
...
//        	blankText: '品牌名称不能为空！'
    	...
    	items:[{
	    	columnWidth:.6,
	    	xtype: 'comboxtree',
	    	storeUrl: 'dept_getCrossAreaTree',
	    	fullPath: true,
	    	name: 'targetDept.id',
	    	fieldLabel:'目标区域',
	    	labelWidth: 60,
...
//            	}
	...
	buttons: [{
	    ...
	    handler: function(btn) {
	    	...
	    	var store = btn.up('startcrosslocalcooperate').store;
